  ...
  return (
    <Container>
      ...
      <Header>
        ...
        <TextoLoren>Lorem Ipsum is simply dummy text of the printing and</TextoLoren> 
        <TextoLoren>typesetting industry. Lorem Ipsum has been the industry's</TextoLoren>
        <TextoLoren>unchanged. It was popularised in the 1960s with the release of</TextoLoren> 
        <TextoLoren>Letraset sheets containing Lorem Ipsum passages, and more</TextoLoren> 
        <TextoLoren>recently with desktop publishing software like Aldus PageMaker</TextoLoren>
        <TextoLoren>including versions of Lorem Ipsum.</TextoLoren>
        
        <TituloTexto>Categorias <AntDesign name="plus" size={20} color="#05148c" /></TituloTexto>
        <EditarLixo>
